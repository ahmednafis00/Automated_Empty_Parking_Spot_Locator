'''
Creates a YAML file with locations of bounding boxes
that the user marks in a frame.

Taken from: https://github.com/ankit1khare/Deep-Neural-Network-based-parking-system
'''
...
cropping = False
data = []
file_path = 'test_video.yml'
img = cv2.imread('frame_initial.jpg')
